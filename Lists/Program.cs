...
// LinkedList linkedList = new LinkedList(new int[] {3});
//
...
linkedList.AddByIndex(3,1);

// linkedList.RemoveLast();
// linkedList.RemoveFewElementsFromStart(2);
...
// int index = linkedList.DeleteByValueReturnIndex(7);
// Console.WriteLine("индекс удаленного = "+ index);
// int count = linkedList.DeleteByValuesReturnCount(8);
// Console.WriteLine("индекс удаленного = "+ count);
// linkedList.AddFirst(2);
// linkedList.Add(23);
